                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  setState(()  {
                                    GetData().removeCartItem(_item[i],i);
                                    refreshData();
                                  });
                                },
                                child: Icon(
                          ...
                          Text(
                            ...
                            style:
                            const TextStyle(fontSize: 20, color: Colors.grey,fontWeight: FontWeight.bold),
                            softWrap: true,
                          ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        setState(() {
                                          _item[i] = GetData().addCart(_item[i],countCart);
                                          refreshData();
                                        });
                                      },
